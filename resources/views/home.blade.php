...
@section('homecontent')
    <div class="jumbotron nopaddings">
      <div class="container">
        ...
        <h3 class="home_page_heading" style="text-align: center; color: #fff">Найдите лучшего <br>
        мастера в своем деле</h3>
        <p class="home_page_text" style="text-align: center; color: #fff">С Sheber.club вы с легкостью, найдете <br>подходящего мастера</p>
            @if(Auth::guest())
